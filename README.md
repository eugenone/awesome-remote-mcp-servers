...
- [Neubau-Radar](https://neubau-radar.ch/integration) `https://neubau-radar.ch/mcp`
  [![Neubau-Radar MCP connector](https://glama.ai/mcp/connectors/ch.neubau-radar/baupublikationen/badges/score.svg)](https://glama.ai/mcp/connectors/ch.neubau-radar/baupublikationen)
  🔓 - Every official Swiss building application on the day it is published, with builder, architect and zone.
